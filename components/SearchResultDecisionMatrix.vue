<script setup lang="ts">
  ...
  const imgURL = computed(() => {
    return `https://cloud.appwrite.io/v1/storage/buckets/protocol-images/files/${props.decision_matrix}/preview?project=64874d27d329773f862c`;
  });
...
<template>
  <section class="w-full py-8 order-first mb-32">
    ...
    <SearchResultSectionEmpty v-else>
      The decision matrix for {{ props.title }} is not available.
